...
const WalletSelectionModal: React.FC<WalletSelectionModalProps> = ({ visible, onClose }) => (
  <Modal className="wallet-selection-modal" title="Connect To Wallet" visible={visible} onCancel={onClose} footer="">
